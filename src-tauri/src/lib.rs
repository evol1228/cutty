...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::media_filmstrip,
            commands::bench_config,
            commands::bench_report,
            commands::bench_snapshot,
            ...
            commands::transition_list,
            commands::text_font_families,
            commands::text_measure,
            engine_ipc::engine_get_state,
            engine_ipc::engine_add_media,
            engine_ipc::engine_remove_media,
            engine_ipc::engine_add_clip,
            engine_ipc::engine_add_text_clip,
            engine_ipc::engine_set_clip_text,
            ...
            engine_ipc::engine_add_keyframe,
            engine_ipc::engine_move_keyframe,
            engine_ipc::engine_remove_keyframe,
            engine_ipc::engine_set_clip_fade,
            engine_ipc::engine_extract_audio,
            engine_ipc::engine_set_clip_transform,
            engine_ipc::engine_set_clip_opacity,
            engine_ipc::engine_set_clip_blend_mode,
            engine_ipc::engine_set_transition,
            engine_ipc::engine_move_clip_to_track,
            engine_ipc::engine_add_track,
            engine_ipc::engine_remove_track,
            engine_ipc::engine_move_track,
            engine_ipc::engine_set_track_flag,
